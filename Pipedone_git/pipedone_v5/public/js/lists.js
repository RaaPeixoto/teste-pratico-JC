...
async function listarPipes() {
    ...
    $(`.pipes h1`).text(`Pipes (${pipes.length})`)
    ...
    $('#lista_pipes').prepend('<div onclick="openNewPipe()" class="notification_1 novo" id="novo_pipe"><i class="fi fi-rr-add"></i><h4>Novo Pipe</h4></div>');
